...
export const API_CONFIG = {
  ...
  MAX_CONCURRENT_TRANSLATIONS: parseInt(process.env.MAX_CONCURRENT_TRANSLATIONS || '5'),
  MAX_CONCURRENT_VIDEO_GENERATIONS: parseInt(process.env.MAX_CONCURRENT_VIDEO_GENERATIONS || '2')
} as const;
