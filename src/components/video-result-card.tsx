  ...
  return (
    <TooltipProvider>
      <Card className={`w-full flex flex-col h-[520px] transition-all duration-200 hover:shadow-lg hover:border-blue-500 hover:-translate-y-1 ${
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <div className="h-[44px] flex items-start">
                      <CardTitle className="text-base font-semibold leading-snug cursor-pointer line-clamp-2 overflow-hidden">
                        {result.koreanPrompt}
                      </CardTitle>
                    </div>
                  </TooltipTrigger>
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <div className="h-[32px] flex items-start">
                        <CardDescription className="text-xs text-gray-500 cursor-pointer line-clamp-2 overflow-hidden">
        ...
        <CardContent className="pt-0 flex-1 flex flex-col min-h-0 pb-3 px-4 h-[400px]">
          <div className="space-y-2 flex-1 flex flex-col min-h-0">
            ...
            {isCompletedStatus(result.status) && result.videoUrl && (
              <div className="space-y-2 flex-1 flex flex-col min-h-0">
                <div className="relative group cursor-pointer rounded-md overflow-hidden bg-black h-[240px]">
                  {result.thumbnailUrl ? (
                    <img
